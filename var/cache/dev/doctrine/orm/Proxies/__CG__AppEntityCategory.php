...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function getEvs(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEvs', []);
     ...
     * {@inheritDoc}
     */
    public function addEv(\App\Entity\Ev $ev): \App\Entity\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEv', [$ev]);

        return parent::addEv($ev);
    }

    /**
     * {@inheritDoc}
     */
    public function removeEv(\App\Entity\Ev $ev): \App\Entity\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEv', [$ev]);

        return parent::removeEv($ev);
    }
