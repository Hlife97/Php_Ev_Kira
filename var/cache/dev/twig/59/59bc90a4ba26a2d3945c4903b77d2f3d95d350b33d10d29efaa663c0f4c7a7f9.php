...
class __TwigTemplate_550fc0353185dbef14df0bda9bc06416eb825e07c4d91c6fae14168e6ba09446 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"center wow fadeInDown\">
                ...
                ";
        // line 14
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["setting"]) || array_key_exists("setting", $context) ? $context["setting"] : (function () { throw new RuntimeError('Variable "setting" does not exist.', 14, $this->source); })()), 0, [], "array", false, false, false, 14), "aboutus", [], "any", false, false, false, 14);
        echo "
            </div>
        </div>
    </div>
...
";
    ...
    {
        return array (  136 => 14,  128 => 8,  118 => 7,  99 => 5,  80 => 4,  61 => 3,  38 => 1,);
    }
...
{% endblock %}", "home/aboutus.html.twig", "C:\\xampp\\htdocs\\ev_kira\\templates\\home\\aboutus.html.twig");
    }
}
