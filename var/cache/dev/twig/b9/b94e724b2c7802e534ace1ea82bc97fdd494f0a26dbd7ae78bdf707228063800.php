...
/* image/new.html.twig */
class __TwigTemplate_70b78a5aa0e124b5065016e4e31aa565d065b7671e429757e10887cd4124510d extends Template
{
    private $source;
    private $macros = [];
...
<form class=\"form-horizontal\" role=\"form\" name=\"image\" action=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_image_new", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 4, $this->source); })())]), "html", null, true);
...
<div class=\"row\">
    <table class=\"table table-light mb-0\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["image"]) {
            ...
            // line 49
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_image_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["image"], "id", [], "any", false, false, false, 49), "hid" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 49, $this->source); })())]), "html", null, true);
            echo "\"
...
<form class=\"form-horizontal\" role=\"form\" name=\"image\" action=\"{{ path('user_image_new', {'id':id}) }}\" method=\"post\" enctype=\"multipart/form-data\">
    <div class=\"card-body\">
        <div class=\"form-group row\">
            <label for=\"fname\" class=\"col-sm-3 text-right control-label col-form-label\">File Name</label>
            <div class=\"col-sm-9\">
    ...
    <table class=\"table table-light mb-0\">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form method=\"post\" action=\"{{ path('user_image_delete', {'id': image.id, 'hid': id}) }}\"
                        onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
                        <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
...
</div>", "image/new.html.twig", "C:\\xampp\\htdocs\\ev_kira\\templates\\image\\new.html.twig");
    }
}
