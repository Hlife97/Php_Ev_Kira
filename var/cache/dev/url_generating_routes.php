...
return [
    ...
    'admin_homes_index' => [[], ['_controller' => 'App\\Controller\\Admin\\HomesController::index'], [], [['text', '/admin/homes/']], [], []],
    'admin_homes_new' => [[], ['_controller' => 'App\\Controller\\Admin\\HomesController::new'], [], [['text', '/admin/homes/new']], [], []],
    'admin_homes_show' => [['id'], ['_controller' => 'App\\Controller\\Admin\\HomesController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/homes']], [], []],
    'admin_homes_edit' => [['id'], ['_controller' => 'App\\Controller\\Admin\\HomesController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/homes']], [], []],
    'admin_homes_delete' => [['id'], ['_controller' => 'App\\Controller\\Admin\\HomesController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/homes']], [], []],
    ...
    'admin_reservation_index' => [[], ['_controller' => 'App\\Controller\\Admin\\ReservationController::index'], [], [['text', '/admin/reservation/']], [], []],
    'admin_reservation_new' => [[], ['_controller' => 'App\\Controller\\Admin\\ReservationController::new'], [], [['text', '/admin/reservation/new']], [], []],
    'admin_reservation_show' => [['id'], ['_controller' => 'App\\Controller\\Admin\\ReservationController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/reservation']], [], []],
    ...
    'user_ev_index' => [[], ['_controller' => 'App\\Controller\\EvController::index'], [], [['text', '/user/ev/']], [], []],
    'user_ev_new' => [[], ['_controller' => 'App\\Controller\\EvController::new'], [], [['text', '/user/ev/new']], [], []],
    'user_ev_show' => [['id'], ['_controller' => 'App\\Controller\\EvController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/user/ev']], [], []],
    ...
    'categori_ev' => [['id'], ['_controller' => 'App\\Controller\\HomeController::categori_ev'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/categori_ev']], [], []],
    ...
    'user_ev' => [[], ['_controller' => 'App\\Controller\\UserController::ev'], [], [['text', '/user/ev']], [], []],
    ...
    'user_reservation_new' => [['id'], ['_controller' => 'App\\Controller\\UserController::newreservation'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/user/reservation']], [], []],
];
